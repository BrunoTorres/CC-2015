...
public class AtendimentoServidor extends Thread {
    ...
    public void registaServidor() throws UnknownHostException, IOException {
        ...
        System.out.println("O meu ip: "+InetAddress.getLocalHost()+" a minha porta: "+portaTCP);
        p.addCampo(c);
        BigInteger bg = BigInteger.valueOf(portaTCP);
        c = new Campo(PORTA, bg.toByteArray());
        p.addCampo(c);
        
        System.out.println("Vou registar o servidor : "+InetAddress.getByName(ipServer)+"   com a porta:"+ portaTCP2);
